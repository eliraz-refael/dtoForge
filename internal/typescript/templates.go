...
{{end}}    {{toCamelCase .Name}}: {{toIoTsType .Type .Nullable}},
{{end}}{{end}}  }),
  t.partial({
...
export type {{.DTO.Name}}Partial = t.TypeOf<typeof {{.DTO.Name}}Partial>;{{end}}
{{end}}
`
...
export type {{.DTO.Name}}Partial = t.TypeOf<typeof {{.DTO.Name}}Partial>;
